...
const Login = () => {
  ...
  const login= async ()=>{
   try{
     ...
     toast.error("enter email or password is incorrect")
   }
  }
         ...
         <div class="signin">
           <div class="content">
              <h2>Login</h2>
               <div class="form">
                <div class="inputBox">
                 <input type="email" required name='email' value={email} onChange={(e)=>setEmail(e.target.value)} /><i>Email</i>
                  </div>
                  <div class="inputBox">
                  <input type="password" required name='password' value={password} onChange={(e)=>setPassword(e.target.value)} /><i>Password</i>
                  </div>

   ...
   <footer>
    <div className="row">
      <div className="col e">
        ...
        <p>shvs u iehf hf q hiwefj huirh ihrkrw dh hiwkd  dhweh khdwdi ehkduiw hwe hruhde  eihd uh ewhdeuhd iehe rhweidhdnew h hdewuh hue whdiu hdefh c hfeufh cdj.</p>
      </div>
      <div className="col e">
        <h3>Main Office</h3>
        <p>Marine Drive road </p>
        <p>Goregaon, Mumbai</p>
        <p>Maharashtra, PIN 567893, India</p>
        <p className="email-id">trends@fashion.com</p>
        <h4>+91 - 0234567892</h4>
      </div>
      <div className="col">
        <h3>Menu-Links</h3>
      ...
      <div className="col">
        ...
        <i class="ri-mail-open-line"></i>
          ...
          <button type='submit'><i class="ri-arrow-right-line arr"></i></button>
        </form>
        <div className="social-icons">
        <i class="ri-facebook-line a"></i>
        <i class="ri-instagram-line a"></i>
        <i class="ri-twitter-line a"></i>
        <i class="ri-github-line a"></i>
        </div>
      </div>
</div>
<hr />
<p className='copyright'>Trends Fashion @ 2023-All RightsReserved</p>
   </footer>
...
<div class="footer_copyright">
  <p>&copy; 2023 The Afterlogo Company Inc.</p>
</div>
</div>
</footer>
</div> */}